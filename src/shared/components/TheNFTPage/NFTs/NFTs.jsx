...
export const NFTs = () => {
  return (
    <div className="w-full h-fit px-[30px] md:px-base pt-[60px] pb-20 mb-1 bg-primary-bg grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-start items-center gap-[30px] grid">
      {NFTS.map((nft, key) => (
        <NFTCard
          key={key + 1}
